...
- 2024/07/28
  - 【Update】指定ユーザーの指定ワードを含むノートをミュートかCWする
- 2024/06/09
  - 【Update】指定ワードをハイライト
- 2024/04/22
  - README.mdの作成
...
- [Misskey用プラグイン](#misskey用プラグイン)
  ...
  - [プラグイン一覧](#プラグイン一覧)
    ...
    - [指定ユーザーの指定ワードを含むノートをミュートかCWする](#指定ユーザーの指定ワードを含むノートをミュートかcwする)
...
### 指定ユーザーの指定ワードを含むノートをミュートかCWする

ユーザーIDとワードの複合条件でミュートやCWができます。  
特定のユーザーだけを対象にワードミュートが可能です。  
なおユーザーとワードは複数設定できますが、ユーザー毎にワードを設定することはできません。

[指定ユーザーの指定ワードを含むノートをミュートかCWする](./指定ユーザーの指定ワードをミュートかCWする.txt)
